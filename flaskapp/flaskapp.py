...
moviefiles = np.load('/home/ubuntu/flaskapp/data/feature_movie_name.npz')
modelfiles = np.load('/home/ubuntu/flaskapp/data/my_movie_model20_10_array.npz')
valuefiles = np.load('/home/ubuntu/flaskapp/data/my_movie_model20_10_value.npy')
